...
func (cu *CompartmentUpdate) SetNillableName(s *string) *CompartmentUpdate {
	if s != nil {
		cu.SetName(*s)
	}
	return cu
...
func (cu *CompartmentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(compartment.Table, compartment.Columns, sqlgraph.NewFieldSpec(compartment.FieldID, field.TypeInt))
	...
	if value, ok := cu.mutation.Name(); ok {
		_spec.SetField(compartment.FieldName, field.TypeString, value)
	}
	if cu.mutation.FridgeCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(fridge.FieldID, field.TypeInt),
			},
		}
...
// SetNillableName sets the "name" field if the given value is not nil.
func (cuo *CompartmentUpdateOne) SetNillableName(s *string) *CompartmentUpdateOne {
	if s != nil {
		cuo.SetName(*s)
	}
	return cuo
...
// Where appends a list predicates to the CompartmentUpdate builder.
func (cuo *CompartmentUpdateOne) Where(ps ...predicate.Compartment) *CompartmentUpdateOne {
...
func (cuo *CompartmentUpdateOne) sqlSave(ctx context.Context) (_node *Compartment, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Compartment.id" for update`)}
	}
