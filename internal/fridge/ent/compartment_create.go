...
func (cc *CompartmentCreate) check() error {
	if _, ok := cc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "Compartment.name"`)}
	}
	return nil
}
...
func (cc *CompartmentCreate) createSpec() (*Compartment, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(compartment.Table, sqlgraph.NewFieldSpec(compartment.FieldID, field.TypeInt))
	)
