...
// ByCollarField orders the results by collar field.
func ByCollarField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newCollarStep(), sql.OrderByField(field, opts...))
	}
}
...
func newCollarStep() *sqlgraph.Step {
