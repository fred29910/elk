...
// EncodeUpdateResponse returns an encoder for responses returned by the calc
// update endpoint.
...
// DecodeUpdateRequest returns a decoder for requests sent to the calc update
// endpoint.
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewUpdateAccount(&body)

		return payload, nil
	}
}

// EncodeUpdateError returns an encoder for errors returned by the update calc
// endpoint.
